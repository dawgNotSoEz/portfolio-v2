          ...
          <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 shadow-xl animate-fade-in-delay transform transition-all duration-500 hover:shadow-indigo-500/20 hover:border-indigo-500/50">
            ...
            <div className="mt-8 flex space-x-4">
              <a 
                ...
                download
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 hover:shadow-blue-500/50 shadow-lg flex items-center relative overflow-hidden group animate-pulse-slow"
              >
