...
const Hero = () => {
  ...
  // Listen to nav hover/active events to animate the name
  useEffect(() => {
    const onHover = (e: Event) => {
      const detail = (e as CustomEvent).detail;
      if (detail === 'home') {
        nameControls.start({ scale: [1, 1.06, 1], transition: { duration: 0.45 } });
      }
    };
    ...
    const onActive = (e: Event) => {
      const detail = (e as CustomEvent).detail;
      if (detail === 'home') {
        nameControls.start({ scale: [1, 1.08, 1], transition: { duration: 0.6 } });
      }
    };

    window.addEventListener('nav-hover', onHover as EventListener);
    window.addEventListener('nav-active', onActive as EventListener);
    return () => {
      window.removeEventListener('nav-hover', onHover as EventListener);
      window.removeEventListener('nav-active', onActive as EventListener);
    };
  }, [nameControls]);
  ...
  return (
    <>
      <section id="home" className="min-h-[110vh] flex items-center justify-center relative overflow-hidden bg-background">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-8 mb-16">
              <h1 className="text-hero font-display font-bold">
                Hi, I'm{" "}
                <motion.span
                  className="block md:inline font-name overflow-hidden"
            ...
            >
              ...
              >
                <span className="button-gradient-text">View My Work</span>
              ...
              >
                <span className="button-gradient-text">Let's Connect</span>
              </Button>
            </motion.div>
            ...
            <motion.div
              variants={itemVariants}
              className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-24"
            >
